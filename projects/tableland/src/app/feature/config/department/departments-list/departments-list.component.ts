...
import { AddDepartmentComponent } from '../add-department/add-department.componenet';
import { UpdateDepartmentComponent } from '../update-department/update-department.componenet';
import { COLUMNS, GLOBAL_FILTER_FIELDS } from './consts';

@Component({
  selector: 'ba-departments-list',
  imports: [
...
export class DepartmentsListComponent {
  ...
  onEdit(id: number) {
    ...
    if (!entity) return;
    this.dialog
      .open(UpdateDepartmentComponent, {
        data: {
          entity,
        },
        minWidth: '40vw',
